...
TOKEN = '8076294653:AAGmpPZwXwHd9mmEtA4HQDhpn6Y3mBJT5Ew'
...
# 2. КАНАЛГА СААТ САЙЫН ПОСТ ЖӨНӨТҮҮ
MESSAGES = [
...
if __name__ == '__main__':
    # 1. Веб-серверди баштоо
    threading.Thread(target=run_flask, daemon=True).start()
    
    # 2. Графикти баштоо
    threading.Thread(target=run_schedule, daemon=True).start()
    
    # 3. Эски байланыштарды тазалап, ботту иштетүү
    print("DEBUG: Бот ишке кирди...")
    bot.remove_webhook()
    time.sleep(1)
